           ...
           <table class="table table-striped">
                ...
                <tbody>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td > <?php echo ($vo["kepu_staitc_page_id"]); ?> </td>
                            <td > <?php echo ($vo["kepu_staitc_page_title"]); ?> </td>
                            <td > 
                                <a href="/thinkkepu/admin.php/StaticPage/del?id=<?php echo ($vo["kepu_staitc_page_id"]); ?>">
