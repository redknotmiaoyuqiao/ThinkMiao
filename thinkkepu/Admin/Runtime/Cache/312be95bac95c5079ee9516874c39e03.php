    ...
    <li>
        <a href="/thinkkepu/admin.php/module/activity">活动列表</a>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <?php if(is_array($activity_list)): $i = 0; $__LIST__ = $activity_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$activity_vo): $mod = ($i % 2 );++$i;?><tr>
                        <td> <?php echo ($activity_vo["kepu_module_activity_id"]); ?></td>
                        <td> <?php echo ($activity_vo["kepu_module_activity_title"]); ?></td>
                        <td> <?php echo ($activity_vo["kepu_module_activity_show"]); ?></td>
                        <td>
                            <a href="<?php echo ($activity_vo["kepu_module_activity_img"]); ?>">
                                <img style="height: 50px;width: 100px;"
                                     src="<?php echo ($activity_vo["kepu_module_activity_img"]); ?>"/>
                            </a>
                        </td>
                        <td>
                            <a href="<?php echo ($activity_vo["kepu_module_activity_url"]); ?>"><?php echo ($activity_vo["kepu_module_activity_url"]); ?></a>
                        </td>
                        <td>
                            <a href="/thinkkepu/admin.php/Module/delActivity?id=<?php echo ($activity_vo["kepu_module_activity_id"]); ?>">
            ...
            <div class="col-md-4">
                <form action="/thinkkepu/admin.php/Module/addActivity" method="post" enctype="multipart/form-data">
