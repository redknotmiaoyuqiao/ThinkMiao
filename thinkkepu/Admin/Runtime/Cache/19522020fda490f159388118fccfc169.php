            ...
            <div class="nav-collapse collapse">
                <ul class="nav" id="menu-layoutit">
                    ...
                    <li>
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-primary" data-target="#downloadModal" rel="/build/downloadModal" role="button" data-toggle="modal"><i class="icon-chevron-down icon-white"></i>提交
                            </button>
