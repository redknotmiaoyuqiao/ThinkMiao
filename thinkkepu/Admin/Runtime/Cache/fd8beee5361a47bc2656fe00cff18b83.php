...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="/"><img src="">山西科普网</a>
                    ...
                    <li>
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-primary" data-target="#downloadModal" rel="/build/downloadModal"
                                    role="button" data-toggle="modal"><i class="icon-chevron-down icon-white"></i>提交</button>
            ...
            <div class="sidebar-nav">
              ...
              <ul class="dropdown-menu">
                  ...
                  <li class=""><a href="#" rel="img-polaroid">相框</a></li>
                            ...
                            <div class="view"> <img alt="140x140" src="__PUBLIC__/layoutit/img/a.jpg"> </div>
                        </div>
                    </li>
                </ul>
                <ul class="nav nav-list accordion-group">
                  ...
                  <li class=""><a href="#" rel="badge-inverse">倒数</a></li>
                        ...
                        <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="icon-remove icon-white"></i>删除</a> <span class="drag label"><i class="icon-move"></i>拖动</span>
                            ...
                            <div class="view">
                                <ul class="thumbnails">
                                    <li class="span4">
                                        <div class="thumbnail"> <img alt="300x200" src="__PUBLIC__/layoutit/img/people.jpg">
                                    ...
                                    <li class="span4">
                                        <div class="thumbnail"> <img alt="300x200" src="__PUBLIC__/layoutit/img/city.jpg">
                                            <div class="caption" contenteditable="true">
                                                <h3>哈佛结构</h3>
                                    ...
                                    <li class="span4">
                                        <div class="thumbnail"> <img alt="300x200" src="__PUBLIC__/layoutit/img/sports.jpg">
                                            <div class="caption" contenteditable="true">
                                                <h3>改进型哈佛结构</h3>
              ...
              <ul class="dropdown-menu">
                  ...
                  <li class=""><a href="#" rel="progress-danger">危险</a></li>
                        ...
                        <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="icon-remove icon-white"></i>删除</a> <span class="drag label"><i class="icon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-mini" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <a class="btn btn-mini" href="#" rel="well">嵌入</a> </span>
                            ...
                            <div class="view">
                                <div class="media"> <a href="#" class="pull-left"> <img src="__PUBLIC__/layoutit/img/a_002.jpg" class="media-object"> </a>
...
<div class="modal hide fade" role="dialog" id="downloadModal">
    ...
    <div class="modal-body">
        <p>页面标题</p><input type="text" id="page_title" />
        <br>
        <p>页面快照</p><textarea type="text" id="page_show"></textarea>
    </div>
