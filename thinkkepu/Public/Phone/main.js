...
function upload(){
    ...
    post("/thinkkepu/admin.php/Phone/add",{content:res,subject_title_t:page_title,subject_show_t:page_show,subject_save_t:abc});
}
...
function onupdate(){
    ...
    var a = getArgs();
    post("/thinkkepu/admin.php/Phone/update?id=" + a['id'],{content:res,subject_save_t:abc});
}
